"""Phased tool exposure / lazy schemas (spec #9). Default OFF → no behavior
change; opt-in via lazy_tools_enabled filters specialist phases out of the
schema until the model calls load_tools(phase)."""
