...
class BudgetPolicyTests(unittest.TestCase):
    def test_budget_policy_has_safe_bounds(self) -> None:
        small = _budget_policy_for_runtime(5, max_tokens=0, max_tool_calls=0, max_replans=0)
    ...
    def test_budget_policy_scales_with_runtime(self) -> None:
        base = _budget_policy_for_runtime(60, max_tokens=0, max_tool_calls=0, max_replans=0)
        larger = _budget_policy_for_runtime(600, max_tokens=0, max_tool_calls=0, max_replans=0)
