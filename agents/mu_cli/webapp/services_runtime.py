...
def mutate_runtime_for_new_session(runtime: Any, payload: dict[str, Any], name: str, deps: RuntimeMutationDeps) -> None:
    ...
    runtime.budget_max_tokens = int(payload.get("budget_max_tokens", runtime.budget_max_tokens) or runtime.budget_max_tokens)
    runtime.budget_max_tool_calls = int(payload.get("budget_max_tool_calls", runtime.budget_max_tool_calls) or runtime.budget_max_tool_calls)
    runtime.budget_max_replans = int(payload.get("budget_max_replans", runtime.budget_max_replans) or runtime.budget_max_replans)
    runtime.retry_max_stall_retries = int(payload.get("retry_max_stall_retries", runtime.retry_max_stall_retries) or runtime.retry_max_stall_retries)
    runtime.retry_max_missing_evidence_retries = int(payload.get("retry_max_missing_evidence_retries", runtime.retry_max_missing_evidence_retries) or runtime.retry_max_missing_evidence_retries)
    runtime.retry_max_tool_failure_retries = int(payload.get("retry_max_tool_failure_retries", runtime.retry_max_tool_failure_retries) or runtime.retry_max_tool_failure_retries)
