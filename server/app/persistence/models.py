...
class JobModel(Base):
    ...
    constraints: Mapped[dict] = mapped_column(JSON().with_variant(SQLITE_JSON, "sqlite"), default=dict)
    ...
    checkpoints: Mapped[dict] = mapped_column(JSON().with_variant(SQLITE_JSON, "sqlite"), default=dict)
    result_artifacts: Mapped[dict] = mapped_column(JSON().with_variant(SQLITE_JSON, "sqlite"), default=dict)
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), server_default=func.now())
